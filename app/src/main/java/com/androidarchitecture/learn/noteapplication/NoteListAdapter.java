...
public class NoteListAdapter extends RecyclerView.Adapter<NoteListAdapter.NoteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position) {
        ...
        if (mNotes != null) {
            ...
            holder.setData(note.getNote(), note.getTextNote(),position);
            holder.setListeners();
    ...
    // Возвращаем int position для onSwiped
    ...
    public class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        public NoteViewHolder(View itemView) {
            ...
            textView = itemView.findViewById(R.id.txvText);
            imgDelete 	 = itemView.findViewById(R.id.ivRowDelete);
            imgEdit 	 = itemView.findViewById(R.id.ivRowEdit);
        }

        public void setData(String note, String text, int position) {
